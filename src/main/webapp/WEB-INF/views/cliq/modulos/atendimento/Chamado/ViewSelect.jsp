...
<g:template filename="/WEB-INF/views/DIAG.jsp">
	...
	<form method='POST'>
		<div class='TEXT'>
			<div class='Minibar'>
				<g:shortcut target='_blank' module="#" screen="#" action="Select" arguments="form.id=${screen.form.id}" title="Destacar chamado"/>
				<g:shortcut target='_blank' module="#" screen="Pessoais" title="Pessoais"/>
				<g:shortcut target='_blank' module="#" screen="DaEquipe" title="Equipe"/>
				<g:shortcut target='_blank' module="#" screen="Chamados" title="Todos"/>
				<g:shortcut target='_blank' module="#" screen="Pesquisa" title="Pesquisar"/>
				<g:shortcut target='_blank' module="#" screen="Contato" title="Contatos"/>
				...
				<g:shortcut target="_report" module="#" screen="#" action="Export" arguments="form.id=${screen.form.id}"/>
			</div>
