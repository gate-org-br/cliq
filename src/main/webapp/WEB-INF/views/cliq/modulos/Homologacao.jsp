			...
			<ul>
				<li>
					...
					<div>
						...
						<div class='Coolbar'>
							<g:link method="post" module="cliq.modulos" screen="#" action="AceitarHomologacao"
								arguments="form.id=${screen.form.id}" tabindex='2'
								data-confirm='Tem certeza de que deseja aceitar a homoloção do chamado?'/>

							<g:link method="post" module="cliq.modulos" screen="#" action="RecusarHomologacao"
								arguments="form.id=${screen.form.id}" tabindex='2'
								data-confirm='Tem certeza de que deseja recusar a homoloção do chamado?'/>
