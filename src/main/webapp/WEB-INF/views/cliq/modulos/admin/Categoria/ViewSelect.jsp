...
<g:template filename="/WEB-INF/views/FULL.jsp">
	<div class='PageControl'>
		<ul>
			<li style='width: 200px' data-selected='${param.tab eq 'Categoria'}'>
				...
				<div>
					<fieldset>
						...
						<fieldset style="width: 50%">
							...
							<div  style="height: calc(100vh - 688px); overflow: auto;">
			...
			<li style='width: 200px' data-selected='${param.tab eq 'Formulario'}'>
				<a href="#" style='text-align: left'>
			...
			<li style='width: 200px' data-selected='${param.tab eq 'Subcategoria'}'>
